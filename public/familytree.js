var FamilyTree = function (e, t) {
 ...
 FamilyTree._defaultConfig = function (e) {
    ...
    if (Array.isArray(this.config.roots))
       for (i = 0; i < this.config.roots.length; i++) this.config.roots[i] == a && (this.config.roots[i] = n);
    if (this.nodes)
    ...
    if (i) {
       if (["mid", "fid"].has(t))
          if (FamilyTree.isNEU(e)) console.error("addParentNode invalid childId");
             ...
             if (!0 === a)
                if (!1 === FamilyTree.events.publish("update", [this, d])) return !1;
    ...
    return !(!i && !r || a || o) || (!(i || r || a || l || !o || n) || (!(i || r || !a || !n) || !(i || r || a || !n)))
 }, FamilyTree.prototype.removeNode = function (e, t, i) {
    var r = this;
    if (this.canRemove(e)) {
    ...
    for (var o = 0; o < a.pids.length; o++) {
       if (!e.pids.has(a.pids[o]))
          if ((s = this._get(a.pids[o])) && s.pids) {
             var l = s.pids.indexOf(e.id); - 1 != l && (s.pids.splice(l, 1), n.push(e)), a.pids.splice(o, 1), n.push(s)
          }
    }
    ...
    for (var t = 0; t < this.config.nodes.length; t++) {
       ...
       for (var r in e) {
          var a = e[r];
          if (i.fid == r && (i.fid = a), i.mid == r && (i.mid = a), Array.isArray(i.pids))
             for (var n = 0; n < i.pids.length; n++) i.pids[n] == r && (i.pids[n] = a)
       }
    }
    ...
    if (I.setAttribute("data-bft-edit-form", ""), I.classList.add("bft-edit-form"), I.classList.add(this.obj.config.mode), I.classList.add(f.templateName), I.classList.add(FamilyTree.ui._defsIds[f.templateName]), Array.isArray(f.tags) && f.tags.length)
    ...
    if (Array.isArray(e) && Array.isArray(t))
       for (var r in e)
          for (var a in t) e[r] == t[a] && i.push(e[r]);
    else if (Array.isArray(e) && !Array.isArray(t))
       for (var r in e)
          for (var a in t) e[r] == a && i.push(e[r]);
    else if (!Array.isArray(e) && Array.isArray(t))
       for (var r in e)
          for (var a in t) r == t[a] && i.push(t[a]);
    return i
    ...
    if (null != i && (a.x = i), null != r && (a.y = i), e && 3 == e.length) {
       var n = e[0].indexOf(t.id); - 1 != n && null != e[1][n].transform && (null == i && (a.x = e[1][n].transform[4]), null == r && (a.y = e[1][n].transform[5]))
    }
    return a
 }, FamilyTree._getOpacity = function (e, t) {
    var i = 1;
    if (e && 3 == e.length) {
       var r = e[0].indexOf(t.id); - 1 != r && null != e[1][r].opacity && (i = e[1][r].opacity)
    }
    return i
    ...
    for (var r = [], a = 0; a < t.length; a++)
       ...
       var o = e.indexOf(r[a]); - 1 != o && e.splice(o, 1)
    }
    t.length && e.push(t[0])
    ...
    if (Array.isArray(t))
       ...
       var n = e.get(t.id);
       if (r.push(n), i.min)
          for (a = 0; a < t.stChildrenIds.length; a++) FamilyTree._exportIterateForJSON_XML_CSV(e, e.getNode(t.stChildrenIds[a]), i, r);
       else
          for (a = 0; a < t.stChildren.length; a++) FamilyTree._exportIterateForJSON_XML_CSV(e, t.stChildren[a], i, r);
       if (i.expandChildren)
          for (a = 0; a < t.childrenIds.length; a++) FamilyTree._exportIterateForJSON_XML_CSV(e, e.getNode(t.childrenIds[a]), i, r);
       else
          for (a = 0; a < t.children.length; a++) FamilyTree._exportIterateForJSON_XML_CSV(e, t.children[a], i, r)
    }
    ...
    return {
       ...
       remove: function (t, i, r) {
          ...
          if (e[t] && Array.isArray(e[t]) && e[t].length > 0)
             for (var n = e[t].length - 1; n >= 0; n--)(!FamilyTree.isNEU(r) && !FamilyTree.isNEU(i) && e[t][n].event_id == r && e[t][n].listener == i || !FamilyTree.isNEU(r) && FamilyTree.isNEU(i) && e[t][n].event_id == r || FamilyTree.isNEU(r) && !FamilyTree.isNEU(i) && e[t][n].listener == i || FamilyTree.isNEU(r) && FamilyTree.isNEU(i)) && (e[t].splice(n, 1), a = !0);
          return a
       },
       has: function (t, i) {
          if (e[t] && Array.isArray(e[t]) && e[t].length > 0) {
    ...
    if (a && (t = a), t) {
       if (Array.isArray(r)) {
          var n = r.indexOf(i.id); - 1 != n && r.splice(n, 1)
       } else r = [];
       r.push(t.id)
    }
    return {
    ...
    var S = {
             ...
             if (d.left || d.right || d.up || d.down) {
                ...
                r.moveStart(d, (function (e) {
                   for (var t = 0; t < m.length; t++) {
                      ...
                      if (c[t].parent)
                         for (s = FamilyTree.ui.link(c[t].parent, r, C, r.response.bordersByRootIdAndLevel, r.nodes, FamilyTree.action.update, !0), d = 0; d < s.length; d++) {
                            var h;
                            p = s[d];
                            (h = r.element.querySelector(`[data-l-id="[${p.id}][${p.childId}]"]`)) && (h.innerHTML = p.html)
                         }
                ...
                if (r.moveEnd(), s.classList && (s.classList.add("bft-cursor-grab"), s.classList.remove("bft-cursor-move"), s.classList.remove("bft-cursor-nodrop"), s.classList.remove("bft-cursor-copy")), I(w, k), w = null, k = null, r.config.enableDragDrop)
                   for (; null != n && n != s;) {
                ...
                for (x = 0; x < m.length; x++) {
                   ...
                   var z = FamilyTree.ui.link(c[x], r, C, r.response.bordersByRootIdAndLevel, r.nodes, FamilyTree.action.update, !0);
                   for (B = 0; B < z.length; B++) {
                      var H = z[B];
                      ($ = r.element.querySelector(`[data-l-id="[${H.id}][${H.childId}]"]`)) && ($.innerHTML = H.html)
                   }
                   if (c[x].parent)
                      for (z = FamilyTree.ui.link(c[x].parent, r, C, r.response.bordersByRootIdAndLevel, r.nodes, FamilyTree.action.update, !0), B = 0; B < z.length; B++) {
                         var $;
                         H = z[B];
                         ($ = r.element.querySelector(`[data-l-id="[${H.id}][${H.childId}]"]`)) && ($.innerHTML = H.html)
                      }
                ...
                if (!e._dragEventFired && (Math.abs(i.x - S.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - S.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)) {
                   if (!1 === FamilyTree.events.publish("drag", [r, a, t, o]) && A(), r.config.enableDragDrop)
                      for (x = 0; x < f.length; x++) s.insertBefore(f[x], s.firstChild);
                   e._dragEventFired = !0
                }
       ...
       A = function (t) {
          ...
          if (r.moveEnd(), s.classList && (s.classList.remove("bft-cursor-grab"), s.classList.remove("bft-cursor-move"), s.classList.remove("bft-cursor-nodrop"), s.classList.remove("bft-cursor-copy")), s.removeEventListener(i.move, N), s.removeEventListener(i.up, A), i.leave && s.removeEventListener(i.leave, A), c[0].id != w && null != w) {
             ...
             if (r.canUpdateLink(c[0].id, w))(d = r.get(c[0].id)).pid = w, d.stpid = null, r.updateNode(d, null, !0);
             else I(w, k);
       ...
       g = function (t) {
          if (c) {
             ...
             if (g.left || g.right || g.up || g.down) {
                ...
                if (s.moveEnd(), d.classList && (d.classList.add("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")), y(o, l), o = null, l = null, s.config.enableDragDrop)
                   for (; null != r && r != d;) {
                      if (r.hasAttribute && r.hasAttribute(FamilyTree.attr.node_id)) {
    ...
    if (d != FamilyTree.action.minimize || e.min ? d == FamilyTree.action.maximize && !0 === e.min ? (c.all || c.id == e.id) && (e.min = !1) : d == FamilyTree.action.exporting && !1 === c.min ? e.min = !1 : d == FamilyTree.action.init && null != m && (e.min = m.min.has(e.id)) : (c.all || c.id == e.id) && (e.min = !0), !e.min)
    ...
    if (FamilyTree.manager._initNode(t, i, s, r, d, c, m), t.isAssistant && (n[t.pid] || (n[t.pid] = []), n[t.pid].push(t.id)), t.subLevels > 0 && o.push(t.id), FamilyTree.MIXED_LAYOUT_FOR_NODES_WITH_COLLAPSED_CHILDREN && !t.isAssistant && t.parent) {
       ...
       for (h = [], f = 0, u = 0, y = 0; y < t.parent.children.length; y++) {
          var g; - 1 == (g = t.parent.children[y]).tags.indexOf("partner") && -1 == g.tags.indexOf("left-partner") && -1 == g.tags.indexOf("right-partner") && -1 == g.tags.indexOf("assistant") && 0 == g.childrenIds.length ? h.push(g.id) : -1 != g.tags.indexOf("assistant") ? f++ : -1 == g.tags.indexOf("partner") && -1 == g.tags.indexOf("left-partner") && -1 == g.tags.indexOf("right-partner") || u++
    ...
    if (FamilyTree.manager.__createNodes(l, s, t, r, a, n, d, e), null != t.roots) {
       ...
       for (var c = 0; c < t.roots.length; c++) {
          ...
          if (m && r == FamilyTree.action.centerNode) {
             ...
             for (var h = l[a.id];
                (null != h.pid || null != h.stpid) && h != m;) h = null == h.pid && null != h.stpid ? l[h.stpid] : l[h.pid];
             p == h && (m = p)
          }
          if (m) {
    ...
    if (r == FamilyTree.action.init && t.expand && t.expand.nodes && null == o)
       for (c = 0; c < t.expand.nodes.length; c++) {
          ...
          for (c = 0; c < re.length; c++)
             for (var v = l[(g = l[re[c]]).pid]; v;) y.push(v.id), null == v.pid && null != v.stpid ? (v = l[v.stpid]).min = !1 : v = l[v.pid]
       } else if (r == FamilyTree.action.centerNode) {
       for (var T = l[a.id]; T;) {
          if (y.push(T.id), a.options.parentState === FamilyTree.COLLAPSE_PARENT_NEIGHBORS && T)
       ...
       for (g = l[a.insertedNodeId]; g;) y.push(g.id), null == g.pid && null != g.stpid ? (g = l[g.stpid]).min = !1 : g = l[g.pid];
    var x = [],
       _ = {},
       w = [],
       k = {},
    ...
    for (c = 0; c < S.length; c++) {
       ...
       for (b = N.length - 1; b >= 0; b--)
          if (A[N[b]])
             for (u = 0; u < A[N[b]].length; u++) g.children.push(l[A[N[b]][u]]), E++, -1 == O.indexOf(N[b]) && O.push(N[b]);
       ...
       for (b = 0; b < I.length; b++)
          if (A[I[b]])
             for (u = 0; u < A[I[b]].length; u++) g.children.push(l[A[I[b]][u]]), M++, -1 == U.indexOf(I[b]) && U.push(I[b]);
    ...
    for (c = 0; c < w.length; c++) {
       ...
       for (b = 0; b < g.subLevels; b++) {
          var H = new FamilyTree.node(g.id + "_sub_level_index_" + b, g.pid, [], "subLevel");
          if (FamilyTree.manager._initDinamicNode(H, g.lcn), v = g.parent)(ue = v.children.indexOf(g)) > -1 && (v.children.splice(ue, 1), v.children.splice(ue, 0, H)), H.children.push(g), H.parent = v, g.parent = H, l[H.id] = H
       }
    }
    for (var $ in _) {
       (v = l[$]).hasAssistants = !0;
       H = new FamilyTree.node(v.id + "_split_assitant_0", v.id, ["assistant"], "split");
       FamilyTree.manager._initDinamicNode(H, v.lcn, !0), l[H.id] = H;
       var j = [];
       for (b = v.children.length - 1; b >= 0; b--) {
          (D = v.children[b]).isAssistant ? (D.parent = null, v.children.splice(b, 1), j.splice(0, 0, D.id)) : D.isPartner || (D.parent && k[D.parent.id] && H && D.parent.id != H.id && (Object.defineProperty(k, H.id, Object.getOwnPropertyDescriptor(k, D.parent.id)), delete k[D.parent.id]), D.parent = H, H.children.unshift(D), v.children.splice(b, 1))
       }
       if (j.length % 2) {
    ...
    if (Z || ee) {
       ...
       if (w.length) {
          ...
          if (ie) {
             ...
             for (var $ in k = {}, ne)
                if (ne[$].length > FamilyTree.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN) {
                   var ce = oe[$];
       ...
       for (var $ in k) {
          ...
          if ((z = i[v.lcn ? v.lcn : "base"]).layout > 0 || ee) {
             te.pnode = v, te.layout = z.layout, te.childrenIds = k[$], te.lastChildrenPidIds = k, te.subLevels = 0, te.layouts = [], FamilyTree.events.publish("node-layout", [e, te]), FamilyTree.events.publish("layout", [te]), te.layouts.length || te.layouts.push({
                layout: te.layout,
             ...
             for (var pe = 0; pe < te.layouts.length; pe++) {
                ...
                for (FamilyTree.isNEU(he.subLevels) && (he.subLevels = 0), FamilyTree.isNEU(he.layout) && (he.layout = z.layout), me = v = l[$]; me.isSplit;) me = l[me.pid];
                for (; me.isSubLevel;) me = l[me.pid];
                var fe = v;
                for (b = 0; b < he.subLevels; b++) {
                   H = new FamilyTree.node(pe + "_sublevel_layout_" + b, fe.id, [], "subLevel");
                   FamilyTree.manager._initDinamicNode(H, fe.lcn), H.parent = fe, fe.children.push(H), l[H.id] = H, fe = H
                }
                if (he.subLevels) {
                   for (b = 0; b < he.childrenIds.length; b++) {
                      var ue;
                      D = l[he.childrenIds[b]]; - 1 != (ue = v.children.indexOf(D)) && v.children.splice(ue, 1), D.parent = fe, fe.children.push(D)
                   }
                   v = fe
                }
                if (he.layout == FamilyTree.layout.mixed) {
                   ...
                   H = new FamilyTree.node(pe + "_" + v.id + "_split_0", me.id, [], "split");
                   FamilyTree.manager._initDinamicNode(H, v.lcn), l[H.id] = H, H.layout = he.layout;
                   var ve = [];
                   ...
                   for (Y = 1, b = ve.length - 1; b >= 0; b--)
                      if (b % 2 && b != ve.length - 1) {
    ...
    if (FamilyTree.VERTICAL_CHILDREN_ASSISTANT)
       for (c = 0; c < s.length; c++) FamilyTree.manager._verticalAssistantIterate(s[c], l);
    te = {
       nodes: l,
       roots: s
    };
    ...
    for (i = 0; i < e.nodes.length; i++)
       for (var r in e.nodes[i]) r !== FamilyTree.ID && r !== FamilyTree.TAGS && r !== FamilyTree.NODES && r !== FamilyTree.PID && r !== FamilyTree.STPID && "movex" !== r && "movey" !== r && (e.nodeBinding[r] || t.has(r) || t.push(r));
    return t
    ...
    if (FamilyTree.manager._isVisible(e, i, r, a)) {
       ...
       if (null != c && null != c.x && null != c.y)
          if (c.x != e.x || c.y != e.y) n && n.dragNodeIdList && -1 != n.dragNodeIdList.indexOf(e.id) || (d[0].push(e.id), d[1].push({
    ...
    if (3 == e.children.length) FamilyTree.manager._verticalAssistantIterate(e.children[0], t), FamilyTree.manager._verticalAssistantIterate(e.children[2], t), FamilyTree.manager._verticalAssistantIterate(e.children[1], t);
       ...
       for (i = 0; i < e.children.length; i++) FamilyTree.manager._verticalAssistantIterate(e.children[i], t);
    ...
    var t = e.nodes;
    if ((e.groupDottedLines.length || e.dottedLines.length) && (t = JSON.parse(JSON.stringify(t))), e.groupDottedLines.length)
          ...
          if (!i.has(n))
             ...
             if (t[o].id == a.from) {
                if ((c = JSON.parse(JSON.stringify(t[o]))).id = `balkan_group_dotted_${a.rootId}_balkan_id_${t[o].id}`, c.pid = `balkan_group_dotted_${a.rootId}_balkan_id_${a.to}`, c.tags) {
                   var l = c.tags.indexOf("group-dotted-lines"); - 1 != l && c.tags.splice(l, 1)
                }
    ...
    if (e.dottedLines.length)
       for (r = 0; r < e.dottedLines.length; r++) {
          ...
          for (o = 0; o < t.length; o++)
             if (t[o].id == d.from) {
                var c;
                if ((c = JSON.parse(JSON.stringify(t[o]))).id = `balkan_dotted_${d.rootId}_balkan_id_${t[o].id}`, d.rootId == d.to ? c.pid = d.to : c.pid = `balkan_dotted_${d.rootId}_balkan_id_${d.to}`, c.tags || (c.tags = []), c.tags.push("bft-dotted-connector"), d.tags)
    ...
    if (null != i.orderBy && c)
       for (var v in c) c[v].sort((function (t, r) {
          var a = e[t].order,
             n = e[r].order;
          return "number" == typeof a || "number" == typeof n ? (null == a && (a = -1), null == n && (n = -1), i.orderBy.desc ? n - a : a - n) : "string" == typeof a || "string" == typeof n ? (null == a && (a = ""), null == n && (n = ""), i.orderBy.desc ? n.localeCompare(a) : a.localeCompare(n)) : void 0
       }));
    ...
    for (p = 0; p < o.length; p++)
       for (var F = 0; F < o.length; F++)
          if (F != p) {
             for (var x = o[p], _ = o[F], w = !1, k = 0; k < x.length; k++)
                if (_.has(x[k])) {
                   w = !0;
                   break
    ...
    if (o) {
       ...
       for (l = 0; l < o.pids.length; l++) {
          var s = a[o.pids[l]];
          if (s)
             for (var d = 0; d < s.rids.length; d++) n.has(s.rids[d]) || n.push(s.rids[d])
       }
       if (i[o.id])
          for (l = 0; l < i[o.id].length; l++) FamilyTree.manager._iterateSetRootIds(i[o.id][l], t, i, r, a, n);
       if (r[o.id])
          for (l = 0; l < r[o.id].length; l++) FamilyTree.manager._iterateSetRootIds(r[o.id][l], t, i, r, a, n)
    }
    ...
    if (t[e])
       for (T = 0; T < t[e].length; T++) FamilyTree.manager._iterateFT(t[e][T], t, i, r, a, n, o, l, s);
    if (i[e])
       for (T = 0; T < i[e].length; T++) FamilyTree.manager._iterateFT(i[e][T], t, i, r, a, n, o, l, s)
 }, FamilyTree.manager.getAllFields = function (e) {
    var t = [FamilyTree.TAGS];
    for (var i in e.nodeBinding) t.push(e.nodeBinding[i]);
    for (i = 0; i < e.nodes.length; i++)
       for (var r in e.nodes[i]) r !== FamilyTree.ID && r !== FamilyTree.TAGS && r !== FamilyTree.NODES && r !== FamilyTree.PID && r !== FamilyTree.STPID && "mid" !== r && "fid" !== r && "pids" !== r && (e.nodeBinding[r] || t.has(r) || t.push(r));
    return t
       ...
       for (g = 0; g < e.children.length; g++) {
          ...
          if (T.isChildOfPartner) switch (s.orientation) {
             ...
             if ((w || T.layout > 1) && T.rightNeighbor && T.rightNeighbor.isSplit) switch (s.orientation) {
                ...
                case FamilyTree.orientation.top:
                case FamilyTree.orientation.top_left:
                   if (1 == T.isPartner) F = FamilyTree.ui._linkLeftToRight(e, T, d, h);
                   else if (2 == T.isPartner) F = FamilyTree.ui._linkRightToLeft(e, T, d, h);
                   else {
                ...
                case FamilyTree.orientation.right:
                case FamilyTree.orientation.right_top:
                   if (1 == T.isPartner) F = FamilyTree.ui._linkTopToBottom(e, T, d, h);
                   else if (2 == T.isPartner) F = FamilyTree.ui._linkBottomToTop(e, T, d, h);
                   else {
                      _ = 1 == T.layout ? void 0 : b.maxX - (b.maxX - u.minX) / 2;
          ...
          if (S) v = S, x = x.replace("{rounded}", S).replace("{edge}", S).replace("{curve}", v);
          else if (-1 != x.indexOf("{rounded}"))
             if (F.xa == F.xb && F.xa == F.xc && F.xa == F.xd || F.ya == F.yb && F.ya == F.yc && F.ya == F.yd) v = "M" + F.xa + "," + F.ya + " L" + F.xd + "," + F.yd, x = x.replace("{rounded}", v);
             else if (Math.abs(F.xa - F.xd) <= FamilyTree.LINK_ROUNDED_CORNERS && Math.abs(F.xa - F.xc) <= FamilyTree.LINK_ROUNDED_CORNERS && Math.abs(F.xa - F.xb) <= FamilyTree.LINK_ROUNDED_CORNERS) v = "M" + F.xa + "," + F.ya + " L" + F.xa + "," + F.yd, x = x.replace("{rounded}", v);
          else if (Math.abs(F.ya - F.yd) <= FamilyTree.LINK_ROUNDED_CORNERS && Math.abs(F.ya - F.yc) <= FamilyTree.LINK_ROUNDED_CORNERS && Math.abs(F.ya - F.yb) <= FamilyTree.LINK_ROUNDED_CORNERS) v = "M" + F.xa + "," + F.ya + " L" + F.xd + "," + F.ya, x = x.replace("{rounded}", v);
          else {
    ...
    _roundedEdge: function (e, t, i, r, a, n) {
       var o, l, s, d = FamilyTree.LINK_ROUNDED_CORNERS,
          c = 0;
    ...
    _draggableLinkPath: function (e, t, i, r, a, n) {
       ...
       if (!FamilyTree._isMoved(i) && FamilyTree._isMoved(t)) {
          ...
          switch (n) {
             case FamilyTree.orientation.top:
             case FamilyTree.orientation.top_left:
                if (r.ya + a / 2 > r.yb) l = !0, s = r.xa < r.xd ? t.x + t.w + a / 2 : t.x - a / 2, d = t.y + t.h + a;
                else {
                   if (r.yb + a / 2 < r.yd) return null;
                   s = r.xa < r.xd ? i.x - a / 2 : i.x + i.w + a / 2, d = i.y - a / 2
                }
             ...
             case FamilyTree.orientation.bottom:
             case FamilyTree.orientation.bottom_left:
                if (r.ya - a / 2 < r.yb) l = !0, s = r.xa < r.xd ? t.x + t.w + a / 2 : t.x - a / 2, d = t.y - a;
                else {
                   if (r.yb - a / 2 > r.yd) return null;
                   s = r.xa < r.xd ? i.x - a / 2 : i.x + i.w + a / 2, d = i.y + i.h + a / 2
                }
             ...
             case FamilyTree.orientation.right:
             case FamilyTree.orientation.right_top:
                if (r.xa - a / 2 < r.xb) l = !0, d = r.ya < r.yd ? t.y + t.h + a / 2 : t.y - a / 2, s = t.x - a;
                else {
                   if (r.xb - a / 2 > r.xd) return null;
                   d = r.ya < r.yd ? i.y - a / 2 : i.y + i.h + a / 2, s = i.x + i.w + a / 2
                }
             ...
             case FamilyTree.orientation.left:
             case FamilyTree.orientation.left_top:
                if (r.xa + a / 2 > r.xb) l = !0, d = r.ya < r.yd ? t.y + t.h + a / 2 : t.y - a / 2, s = t.x + t.w + a;
                else {
                   if (r.xb + a / 2 < r.xd) return null;
                   d = r.ya < r.yd ? i.y - a / 2 : i.y + i.h + a / 2, s = i.x - a / 2
                }
    ...
    this.element = e, this.requestParams = i, this.config = t, this.onSetViewBoxCallback = r, this.onDrawCallback = a, this.pos = 0, this.bar = null
    ...
    if ((this.config.mouseScrool == FamilyTree.action.xScroll || this.config.mouseScrool == FamilyTree.action.scroll) && this.bar) {
       ...
       ! function (e, r, a) {
          ...
          function o() {
             n = !0;
             var e = (t.pos - t.bar.scrollLeft) / a;
             if (e > 0) e++;
             else {
                if (0 == e) return void(n = !1);
                e--
             }
             Math.ceil(t.bar.scrollLeft) == Math.ceil(t.pos) ? n = !1 : (t.bar.scrollLeft += e, l(o))
          }
          e.addEventListener("wheel", (function (e) {
             if (e.ctrlKey) return;
             var a = 0;
             if (t.config.mouseScrool == FamilyTree.action.xScroll)(a = e.deltaX || e.wheelDeltaX) || (a = e.deltaY || e.wheelDeltaY);
             else if (t.config.mouseScrool == FamilyTree.action.scroll && !(a = i || !e.shiftKey ? e.deltaX || e.wheelDeltaX : e.deltaY || e.wheelDeltaY)) return;
             a = -a, a = Math.max(-1, Math.min(1, a)), t.pos += -a * r;
    ...
    if (this.config.showXScroll === FamilyTree.scroll.visible || this.config.mouseScrool === FamilyTree.action.scroll || this.config.mouseScrool === FamilyTree.action.xScroll) {
       ...
       this.requestParams();
       this.innerBar.innerHTML = " ", Object.assign(this.bar.style, {
          position: "absolute",
          left: 0,
          bottom: 0,
          width: e + "px",
    ...
    if (this.bar) {
       ...
       var a = (parseFloat(this.innerBar.clientWidth) - parseFloat(this.bar.clientWidth)) / 100,
          n = r * a;
       this.bar.ignore = !0, this.bar.scrollLeft = n, this.pos = this.bar.scrollLeft, this.bar.style.visibility = a <= 0 ? "hidden" : "", this.config.showXScroll !== FamilyTree.scroll.visible && (this.bar.style.visibility = "hidden")
    }
    ...
    if ((this.config.mouseScrool == FamilyTree.action.yScroll || this.config.mouseScrool == FamilyTree.action.scroll) && this.bar) {
       ...
       ! function (e, r, a) {
          ...
          function o() {
             n = !0;
             var e = (t.pos - t.bar.scrollTop) / a;
             if (e > 0) e++;
             else {
                if (0 == e) return void(n = !1);
                e--
             }
             Math.ceil(t.bar.scrollTop) == Math.ceil(t.pos) ? n = !1 : (t.bar.scrollTop += e, l(o))
          }
          e.addEventListener("wheel", (function (e) {
             if (e.ctrlKey) return;
             var a = 0;
             if (t.config.mouseScrool == FamilyTree.action.yScroll)(a = e.deltaY || e.wheelDeltaY) || (a = e.deltaX || e.wheelDeltaX);
             else if (t.config.mouseScrool == FamilyTree.action.scroll && !(a = i || !e.shiftKey ? e.deltaY || e.wheelDeltaY : e.deltaX || e.wheelDeltaX)) return;
             a = -a, a = Math.max(-1, Math.min(1, a)), t.pos += -a * r;
    ...
    if (this.config.showYScroll === FamilyTree.scroll.visible || this.config.mouseScrool === FamilyTree.action.scroll || this.config.mouseScrool === FamilyTree.action.yScroll) {
       var t = this;
       this.bar && this.bar.parentNode && this.bar.parentNode.removeChild(this.bar), this.bar = document.createElement("div"), this.innerBar = document.createElement("div"), this.innerBar.innerHTML = " ", Object.assign(this.bar.style, {
          position: "absolute",
          right: 0,
          bottom: 0,
          height: e + "px",
    ...
    if (this.bar) {
       ...
       var a = (parseFloat(this.innerBar.clientHeight) - parseFloat(this.bar.clientHeight)) / 100,
          n = r * a;
       this.bar.ignore = !0, this.bar.scrollTop = n, this.pos = this.bar.scrollTop, this.bar.style.visibility = a <= 0 ? "hidden" : "", this.config.showYScroll !== FamilyTree.scroll.visible && (this.bar.style.visibility = "hidden")
    }
    ...
    var a, n, o, l = e.element.querySelector("#bft-ppdf-size"),
    ...
    for (var i = "", r = 0; r < this.config.clinks.length; r++) {
       ...
       function _(e, t, i) {
          ...
          return n = n / (Math.sqrt(r * r + a * a) * i) * FamilyTree.CLINK_CURVE, {
             x: e.x + r / 2 - a * n,
             y: e.y + a / 2 + r * n
          }
       }
    ...
    function n(t, n, o) {
       ...
       if (pathStr = FamilyTree.roundPathCorners(s, FamilyTree.LINK_ROUNDED_CORNERS, !1), l.label) {
          var L = h.label.replace("{x}", I.x).replace("{y}", I.y).replace("{val}", l.label),
          ...
          i += h.label.replace("{x}", I.x).replace("{y}", I.y + M).replace("{val}", l.label)
       }
       var U = t.id,
          O = n.id;
       o && (U = n.id, O = t.id), i += ("<g " + FamilyTree.attr.s_link_from + '="{from}" ' + FamilyTree.attr.s_link_to + '="{to}">').replace("{from}", U).replace("{to}", O) + h.link.replaceAll("{d}", pathStr) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + pathStr + '" />', i += FamilyTree.grCloseTag
    }
    ...
    if (e.config.miniMap) {
       if (e.manager.action != FamilyTree.action.move) {
          ...
          var r, a, n, o, l = e.element.querySelector('[data-id="mini-map-focus"]'),
             s = !1,
             d = null;
          l.onmousedown = function (e) {
             var t, n, o, d = l.getBoundingClientRect(),
                c = d.left,
                m = d.top;
    ...
    ! function e(t, n) {
       if (Array.isArray(n))
          for (var o = 0; o < n.length; o++) e(t, n[o]);
       else {
    ...
    for (var o = a.length / 100, l = 0, s = 0, d = l > 0 ? 100 : 0, c = 0, m = 0; m < e.length; m++)
    ...
    if (n.length) {
       ...
       for (h = 0; h < n.length; h++)
          if (l += n[h].length, n[h].start < s && (s = n[h].start), h >= 1 && n[h - 1].start > n[h].start) {
             d = 0;
             break
          }
    }
    ...
    var r = {};
    if (t.binding || (t.binding = ""), t.label || (t.label = ""), "select" != t.type || Array.isArray(t.options) ? r.options = t.options : r.options = [], r.value = e && !FamilyTree.isNEU(e[t.binding]) ? e[t.binding] : "", i && r.options)
       for (var a = 0; a < r.options.length; a++)
          if (r.options[a].value == r.value) {
             r.value = r.options[a].text;
             break
          } if (r.id = FamilyTree.elements.generateId(), r.disabledAttribute = i ? "data-bft-input-disabled" : "", r.readOnlyAttribute = i ? "readonly" : "", r.id = r.id, i && FamilyTree.isNEU(r.value) && (r.doNotRender = !0), i && "photo" == t.binding && (r.id = null, r.doNotRender = !0), r.binding = t.binding, r.label = t.label, r.vlidators = "", t.vlidators)
    ...
    if (this.instance.config.filterBy) {
       ...
       if ("all" == this.instance.config.filterBy)
          for (var t = FamilyTree.manager.getAllFields(this.instance.config), i = 0; i < t.length; i++) {
             var r = t[i];
             "tags" != r && "id" != r && "pid" != r && "ppid" != r && "stpid" != r && (e[r] = {})
          } else if (Array.isArray(this.instance.config.filterBy))
             for (i = 0; i < this.instance.config.filterBy.length; i++) e[this.instance.config.filterBy[i]] = {};
       ...
       if (null != this.filterBy)
          for (var s in e)
             if (this.filterBy[s])
                for (var d in e[s]) this.filterBy[s][d] && (e[s][d] = this.filterBy[s][d]);
       this.filterBy = e;
       var c = this;
                   ...
                   if (t) {
                      ...
                      if (e.target.hasAttribute("data-all")) {
                         for (var r = e.target.parentNode.parentNode.querySelectorAll("input"), a = 0; a < r.length; a++)
                            if (r[a] != e.target)
                               for (var n in r[a].checked = e.target.checked, c.filterBy[i]) c.filterBy[i][n].checked = e.target.checked
                      } else if (null != c.filterBy[i][this.name] && (c.filterBy[i][this.name].checked = this.checked), this.checked)
                         for (var o = c.instance.config.nodes, l = 0; l < o.length; l++)
                            if (o[l][i] == this.name)
                               for (var s = o[l]; s;)
                                  if (FamilyTree.isNEU(s.stpid)) s = FamilyTree.isNEU(s.pid) ? null : c.instance._get(s.pid);
